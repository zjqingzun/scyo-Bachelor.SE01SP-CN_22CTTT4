...
# # Tạo danh sách các đối tượng tk.Button và gán command
# button_objects = [tk.Button(root, text=text, 
#                             command=lambda i=i: button_click(i)) for i,
#                   text in enumerate(button_texts)]

# # Pack các đối tượng tk.Button vào cửa sổ
...
# def button_click(value, button_values):
#     print(f"Button clicked with value: {value}, {button_values}")

# root = tk.Tk()
# root.title("Button List Example")

# button_values = ["Value 1", "Value 2", "Value 3"]

# # Hàm trung gian để chuyển đối tượng tk.Button và giá trị tương ứng vào hàm command
# def create_button(value):
#     return tk.Button(root, text=value, command=lambda: button_click(value))

# # Tạo danh sách các đối tượng tk.Button và gán command
# button_objects = [create_button(value) for value in button_values]
...
def show_notification():
    notification_label.place(x=10, y=10)  # Hiển thị label ở vị trí mong muốn
    root.after(10000, hide_notification)  # Tự động ẩn sau 3000 milliseconds (3 giây)

def hide_notification():
    notification_label.place_forget()  # Ẩn label
...
# Tạo label thông báo
notification_label = tk.Label(root, text="Thông báo tạm thời", bg="yellow")

# Tạo nút để hiển thị thông báo
show_button = tk.Button(root, text="Hiển thị thông báo", command=show_notification)
...
#         print(f"An error occurred: {e}")
#         return None
# def handle__notification_update(type : str) :
#     path = './app/email/data/notification.txt'
    
#     noti = handle__read(path)
...
# if handle__notification_update('check') :
#     print("True")
# else :
#     print("False")
    
# handle__notification_update('change')
